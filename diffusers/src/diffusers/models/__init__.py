...
if is_torch_available():
    ...
    _import_structure["autoencoders.autoencoder_kl_realrestorer"] = ["RealRestorerAutoencoderKL"]
    ...
    _import_structure["transformers.transformer_realrestorer"] = ["RealRestorerTransformer2DModel"]
