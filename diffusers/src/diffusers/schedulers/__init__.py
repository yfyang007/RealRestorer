...
try:
    ...
    _import_structure["scheduling_realrestorer_flow_match"] = ["RealRestorerFlowMatchScheduler"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .scheduling_realrestorer_flow_match import RealRestorerFlowMatchScheduler
